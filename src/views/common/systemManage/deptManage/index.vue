  ...
  <div class="app-container">
    <basic-container>
            ...
            <el-row :gutter="20" class="row-span">
              ...
              <el-col :xl="4" :lg="7" :md="8" :sm="10" :xs="10">
                <el-button
                  ...
                  icon="el-icon-search"
                  @click="toQuery"
                  v-if="$buttonPrvgs('S_DEPT_MANAGE.SELECT')"
                >搜索</el-button>
                <el-button
                  size="medium"
                  style="float:left"
        ...
        <el-row :gutter="20" class="row-span">
          <el-col :xl="20" :lg="24" :md="24" :sm="24" :xs="24">
            <el-button
              ...
              size="medium"
              @click="add"
              v-if="$buttonPrvgs('S_DEPT_MANAGE.ADD')"
            >新增</el-button>
            ...
            <el-button
              ...
              size="medium"
              @click="edit"
              v-if="$buttonPrvgs('S_DEPT_MANAGE.EDIT')"
            >编辑</el-button>
            ...
            <el-button
              ...
              size="medium"
              @click="recover"
              v-if="$buttonPrvgs('S_DEPT_MANAGE.ENABLE')"
            >启用</el-button>
            ...
            <el-button
              ...
              size="medium"
              @click="stop"
              v-if="$buttonPrvgs('S_DEPT_MANAGE.DISABLE')"
            >禁用</el-button>
          </el-col>
      ...
      >
        ...
        <el-table-column align="center" prop="inputTime" v-if="showCol.inputTime.value" :label="showCol.inputTime.label" />
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="35%" @closed="clearDialog" :close-on-press-escape="false" :close-on-click-modal="false">
      <div>
        <el-form label-position="right" label-width="200px"  :model="dialogFrom" ref="dialogFrom" :rules="rules">
          <el-form-item label="机构名称：" size="medium" prop="orgId">
...
export default {
  ...
  methods: {
    ...
    selectOrg1(id){
      if(id!=null){
        this.$refs.orgSelectTree1.toggleDropDownVisible();
      }
    },
    selectOrg(id){
      if(id!=null){
    ...
    beforeInit() {
      this.url = baseUrl+"/deptInfo/list";
